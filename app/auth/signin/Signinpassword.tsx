    ...
    <>
      <Card className='border-none '>
          <CardContent className="space-y-2 ">
           ...
           <Label className='text-red-700'>Forgot Password</Label>
           </div>
           <Input type='password'/>
           </div>
          </CardContent>
          <CardFooter className='block'>
            <Button className='bg-red-700 w-full block mb-2 hover:bg-red-600'>Sign In &rarr;</Button>
            <div className="text-end text-xs font-bold">Login using <Link href={'/'} className='text-red-700'>Mobile Number</Link></div>
