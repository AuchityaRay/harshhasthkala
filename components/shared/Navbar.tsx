    ...
    <>
      <div className="flex justify-between px-5 md:px-10 py-6 items-center">
        <div className="logo flex items-center">
          <img src="/assets/vector.png" alt="nav" className="me-8 cursor-pointer" />
      ...
      {isMenuOpen && (
        <div className="flex justify-center flex-col md:flex-row  bg-red-600 text-white py-5 px-5">
          <Link href="/" onClick={toggleMenu} className="lg:mx-10 mx-4 mb-5 md:mb-0 font-[Algreya]">
            Home
          </Link>
          <Link href="/" onClick={toggleMenu} className="lg:mx-10 mx-4 mb-5 md:mb-0 font-[Algreya]">
            Art On The Wall
          ...
          <Link href="/" onClick={toggleMenu} className="lg:mx-10 mx-4 font-[Algreya]">
            Offers
          </Link>
        </div>
      )}
